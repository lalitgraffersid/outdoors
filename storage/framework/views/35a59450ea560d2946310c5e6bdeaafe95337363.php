...
<section class="position-relative page-header project-page-header">
    ...
    margin: 0px 10px;"
                ...
                <tr>
                    ...
                    <td>
                    <td class="total_price"><strong>Total €<?php echo e($total); ?>.00</strong></td>
                </tr>
                <tr>
                    <td>
...
<?php echo $__env->make('front.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/outdoorstructuresireland.com/httpdocs/resources/views/front/products/cart.blade.php ENDPATH**/ ?>