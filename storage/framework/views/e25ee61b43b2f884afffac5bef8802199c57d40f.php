...
if ($total < 375) {
  ...
  ?>
                  ...
                  <td colspan="2" style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; font-weight: normal; line-height: 20px; text-align: left; border: 1px solid #ccc; padding: 10px;">€ <?php echo e($shiping); ?></td>
                  </tr>
                  <tr>
                    ...
                    <td colspan="2" style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; font-weight: bold; line-height: 20px; text-align: left; border: 1px solid #ccc; padding: 10px;"><strong>€<?php echo e($total + $shiping); ?></strong></td>
                  </tr>
                </table>

  <?php $__env->stopSection(); ?>
<?php echo $__env->make('front.emails.emailMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/outdoorstructuresireland.com/httpdocs/resources/views/front/emails/emailPaypal.blade.php ENDPATH**/ ?>