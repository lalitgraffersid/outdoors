...
<body>
                                ...
                                <nav class="navbar navbar-expand-md navbar-light">
                                    ...
                                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                        <ul class="navbar-nav ml-auto py-4 py-md-0 top-call">
                                            ...
                                            <li class="nav-item pl-4 pl-md-0 ml-0 <?php echo e($current_route == 'products' ? 'active' : ''); ?>">
    ...
    </header><?php /**PATH C:\xampp\htdocs\outdor2\resources\views/front/includes/head.blade.php ENDPATH**/ ?>