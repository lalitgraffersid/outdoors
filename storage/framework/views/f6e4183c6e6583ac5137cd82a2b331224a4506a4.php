        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Enquire Details</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="card">
        ...
        <div class="card-body">
                  ...
                  <div class="col-md-12">
                     ...
                     <div class="post">
                        ...
                        <ul class="cus-info">
                           ...
                           <li><span>Product:</span> <?php echo e($result->name); ?></li>
          ...
          <div class="card-footer">
              <div>
                 <a href="<?php echo e(route('enquires.index')); ?>" class="btn btn-primary btn-secondary float-sm-right">Back</a>
              </div>
           </div>
        </div>
        <!-- /.card-body -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/outdoorstructuresireland.com/httpdocs/resources/views/admin/enquires/view.blade.php ENDPATH**/ ?>