...
<!-- Brand Logo -->
   ...
   <div class="sidebar">
      ...
      <nav class="mt-2">
         <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
               <a href="<?php echo e(route('brands.index')); ?>" class="nav-link <?php if($current_route == 'brands.index'){echo 'active';} ?>"><i class="nav-icon fas fa-cogs"></i><p>
                Brands</p></a>
            </li>
            <li class="nav-item has-treeview">
               <a href="<?php echo e(route('pcategories.index')); ?>" class="nav-link <?php if($current_route == 'pcategories.index'){echo 'active';} ?>"><i class="nav-icon fas fa-cogs"></i><p>
                Categories</p></a>
            </li>
            <li class="nav-item has-treeview">
               <a href="<?php echo e(route('products.index')); ?>" class="nav-link <?php if($current_route == 'product.index'){echo 'active';} ?>"><i class="nav-icon fas fa-cogs"></i><p>
                Products</p></a>
            </li>
			 <li class="nav-item has-treeview">
               <a href="<?php echo e(route('enquires.index')); ?>" class="nav-link <?php if($current_route == 'enquires.index'){echo 'active';} ?>"><i class="nav-icon fas fa-cogs"></i><p>
               Product Enquires</p></a>
            </li>
            <li class="nav-item has-treeview">
               <a href="<?php echo e(route('order.index')); ?>" class="nav-link <?php if($current_route == 'order.index'){echo 'active';} ?>"><i class="nav-icon fas fa-cogs"></i><p>
                Orders</p></a>
            </li>
 ...
 <?php /**PATH /var/www/vhosts/outdoorstructuresireland.com/httpdocs/resources/views/admin/includes/sidebar.blade.php ENDPATH**/ ?>