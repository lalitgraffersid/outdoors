                        ...
                        <div class="form-group">
                           ...
                           <select name="category_id" class="form-control">
                              ...
                              <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 <option value="<?php echo e($value->id); ?>" <?php if($value->id == $result->category_id){echo "selected";} ?>><?php echo e($value->name); ?></option>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                           </select>
                        </div>
                           ...
                           <div class="col-md-6">
                              ...
                              <?php if(!empty($result->featured_image)): ?>
                                 ...
                                 <div class="custom_close">
                                    <img src="<?php echo e(asset('/public/admin/clip-one/assets/projects/featured_image/thumbnail')); ?>/<?php echo e($result->featured_image); ?>" alt="" class="product-edit-img">
                                 </div>
                              <?php endif; ?>
                           </div>
                           ...
                           <div class="col-md-6">
                              ...
                              <?php if(count($additionalImages)>0): ?>
                                 ...
                                 <?php $__currentLoopData = $additionalImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="custom_close">
                                       <img src="<?php echo e(asset('/public/admin/clip-one/assets/projects/additional_images/thumbnail')); ?>/<?php echo e($value->image); ?>" alt="" class="product-edit-img"> 
...
<script>
   $(document).ready(function(){
     $('.product-edit-btn').on('click',function(){
         ...
         $.ajax({
             url: "<?php echo e(url('admin/projects/image/delete')); ?>/"+id,
             method: "get",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aobhfo788oyt/public_html/resources/views/admin/projects/edit.blade.php ENDPATH**/ ?>