...
if ($total < "375") {
  ...
  ?>
      ...
      <div id="noCharge">
         <p class="total">Total : <span class="amount">€<?php echo e($total + $shiping); ?></span></p>
      </div>
...
<?php echo $__env->make('front.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/outdoorstructuresireland.com/httpdocs/resources/views/front/products/checkout.blade.php ENDPATH**/ ?>