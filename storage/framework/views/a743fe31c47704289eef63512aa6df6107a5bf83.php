         ...
         <div class="row">
            ...
            <?php if(Session::has('msg')): ?>
               ...
               <div class="contact-form">
                  <form id="quickForm" action="<?php echo e(route('calculator.save')); ?>" method="POST">
                     ...
                     <input type="text" name="product" value="<?php echo e($data['product']); ?>" class="form-control" placeholder="Product Name" required="">
                     <input type="text" name="length" value="<?php echo e($data['length']); ?>" class="form-control" placeholder="Length" required="">
                     <input type="text" name="width" value="<?php echo e($data['width']); ?>" class="form-control" placeholder="Width" required="">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\outdoor_june\resources\views/front/calculator.blade.php ENDPATH**/ ?>