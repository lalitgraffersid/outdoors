...
<link rel="stylesheet" href="<?php echo e(asset('assets/front/css/cookieconsent.min.css')); ?>">
...
<body>
                                ...
                                <nav class="navbar navbar-expand-md navbar-light">
                                    ...
                                    <div class="collapse navbar-collapse " id="navbarSupportedContent">
                                        <ul class="navbar-nav ml-auto py-4 py-md-0 top-call " >
                                            ...
                                            <li class="nav-item pl-4 pl-md-0 ml-0 <?php echo e($current_route == 'home' ? 'selected_btn' : ''); ?>">
                                                <a class="<?php echo e($current_route == 'home' ? 'linkselct' : 'nav-link'); ?>" href="<?php echo e(route('home')); ?>">HOME</a>
                                            </li>
                                            <li class="nav-item pl-4 pl-md-0 ml-0 <?php echo e($current_route == 'about_us' ? 'selected_btn' : ''); ?>">
                                                <a class="<?php echo e($current_route == 'about_us' ? 'linkselct' : 'nav-link'); ?>" href="<?php echo e(route('about_us')); ?>">ABOUT US</a>
                                            </li>
                                            <li class="nav-item pl-4 pl-md-0 ml-0 <?php echo e($current_route == 'services' ? 'selected_btn' : ''); ?>">
                                                <a class="<?php echo e($current_route == 'services' ? 'linkselct' : 'nav-link'); ?> dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">SERVICES<span class="has-sub"></span></a>
 ...
 <li class="nav-item pl-4 pl-md-0 ml-0 <?php if($current_route == 'products'){echo "selected_btn";} ?>">
    ...
    <div class="dropdown-menu">
        <?php $__currentLoopData = $pcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a class="dropdown-item" href="<?php echo e(route('products',$value->id)); ?>"><?php echo e($value->title); ?></a>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
</li>
											</div>	
    <div style="margin-top: 4px;">											
      <li class="contact-li">
                                            ...
                                            <li class="cart">
                                            <?php echo $__env->make('front/includes/cart', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>                                          
    ...
    </header><?php /**PATH /var/www/vhosts/outdoorstructuresireland.com/httpdocs/resources/views/front/includes/head.blade.php ENDPATH**/ ?>