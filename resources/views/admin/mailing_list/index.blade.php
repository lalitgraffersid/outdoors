           ...
           <div class="col-lg-12">
              <div class="card">
                  <div class="card-header float-right">
                     <a href="{{route('mailing_list.add')}}" class="btn btn-info float-right"><i class="fas fa-plus"></i> {{$data['actionData']->action_title}} </a>
                  ...
                  <div class="modal fade" id="modal-default">
                     <div class="modal-dialog">
                        <div class="modal-content">
                           ...
                           <form id="quickForm" action="{{route('mailing_list.send_mail')}}" method="POST" enctype="multipart/form-data" >
                              {{csrf_field()}}
