         ...
         <div class="row">
            <div class="col-md-12">
               <div class="card card-primary">
                  ...
                  @endif
                  <form id="quickForm" action="{{route('pages.save')}}" method="POST" enctype="multipart/form-data" >
                     {{csrf_field()}}
                     <div class="card-body">

                        <div class="form-group">
                           <label for="name">Name</label>
                           <input type="text" name="name" value="{{ old('name') }}" class="form-control" id="name" placeholder="Page Name">
                        </div>
