                           ...
                           <div class="col-md-6">
                              ...
                              @if (!empty($result->featured_image))
                                 ...
                                 <div class="custom_close">
                                    <img src="{{ asset('/public/admin/clip-one/assets/services/featured_image/thumbnail')}}/{{ $result->featured_image }}" alt="" class="product-edit-img">
                                 </div>
                              @endif
                           </div>
                           ...
                           <div class="col-md-6">
                              ...
                              @if (count($additionalImages)>0)
                                 ...
                                 @foreach($additionalImages as $value)
                                    <div class="custom_close">
                                       <img src="{{ asset('/public/admin/clip-one/assets/services/additional_images/thumbnail')}}/{{ $value->image }}" alt="" class="product-edit-img"> 
