      ...
      <div class="about-content">   
         <div class="row">
            ...
            <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12 ">
               <div>
                  <h4>Address:</h4>
                  <p class="offset-1"><i class="fa fa-building"></i> {{$settings->address}}</p>
               </div>
               <div class="mt-3">
                  <h4>Call:</h4>
                  <p class="offset-1"><i class="fa fa-phone"></i> {{$settings->name_1}}: <a href="callto:{{$settings->phone_1}}">{{$settings->phone_1}}</a></p>
                  <p class="offset-1"><i class="fa fa-phone"></i> {{$settings->name_2}}: <a href="callto:{{$settings->phone_2}}">{{$settings->phone_2}}</a></p>
               </div>
               <div class="mt-3"></div>
               <h4>Email:</h4>
