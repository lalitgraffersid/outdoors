            ...
            @if(session('cart'))
                @foreach(session('cart') as $id => $details)
                    ...
                    <tr>
                        ...
                        <td data-th="Price">€{{ $details['price'] * $details['quantity'] }}</td>
...
if ($total < "375") {
  ...
  ?>
      ...
      <div id="noCharge">
         <p class="total">Total : <span class="amount">€{{ $total + $shiping }}</span></p>
      </div>
      ...
      <div class="paypal">
        ...
        <form class="" method="POST" id="payment-form" action="{!! URL::to('make/payment') !!}">
            <div class="check_txt">
            {{ csrf_field() }}
...
<script src="{{ asset('/frontend/js/jquery-3.4.1.min.js') }}" type="text/javascript"></script> 
