...
<section class="position-relative page-header project-page-header">
  ...
  <img  src="{{url('/public/admin/clip-one/assets/products/original')}}/{{$images[0]->image}}" id="expandedImg" style="width:100%">
  <div id="imgtext"></div>
</div>
	     	<div class="row">
         ...
         @foreach($images as $image)
		        	...
		        	<div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
		          	<div class="column abt-img">
		             	...
		             	<img src="{{url('/public/admin/clip-one/assets/products/original')}}/{{$image->image}}" class="abt-img-responsive" onclick="myFunction(this);">
