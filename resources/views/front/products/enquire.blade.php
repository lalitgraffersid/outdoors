         ...
         <div class="row">
            ...
            @if(Session::has('msg'))
               ...
               <div class="contact-form">
                  <form id="quickForm" action="{{route('enquire.save')}}" method="POST">
                     {{csrf_field()}}
                     ...
                     <input type="text" name="product" value="{{ old('product') }}" class="form-control" placeholder="Product Name" required="">
